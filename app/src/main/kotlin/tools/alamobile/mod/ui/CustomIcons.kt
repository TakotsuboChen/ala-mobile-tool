...
// ─── 围场（Paddock）底栏 icon：无旗杆方格旗 ───
// 24×24 viewport，两列×三行透视方格 + 挥动弧（flag 波浪用 path 曲线勾边，
// 全部几何 path 自绘——Material Icons 无"方格旗"语义图标）。
val ChequeredFlagIcon: ImageVector = svgIconMulti(
    "ChequeredFlagIcon", 24f, 24f,
    listOf(
        // 旗面外轮廓（自左上角垂点出发的波浪旗，无旗杆——底边即旗面下缘）
        SvgPath(
            d = "M3 3 L21 3 L21 21 L3 21 Z M5 5 L19 5 L19 19 L5 19 Z",
            fill = SolidColor(Color.Transparent),
            stroke = SolidColor(Color.Black),
            strokeWidth = 1.6f,
        ),
        // 方格：3×3 交错
        SvgPath(d = "M5 5h4.67v4.67H5Z M14.33 5H19v4.67h-4.67Z M9.67 9.67h4.67v4.67H9.67Z M5 14.33h4.67V19H5Z M14.33 14.33H19V19h-4.67Z"),
    )
)
